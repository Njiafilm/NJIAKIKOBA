...
def home():
    ...
    conn.close()
    return render_template("index.html", settings=settings, lang=session.get("lang", "sw"), t=TRANSLATIONS[session.get("lang", "sw")])
...
def developer_dashboard():
    ...
    conn.close()
    return render_template("developer_dashboard.html", stats=stats, logs=logs, settings=settings, counts=counts)
